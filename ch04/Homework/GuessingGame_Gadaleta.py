...
def game_loop():
    ...
    while not correct:
        ...
        correct, responce = check_guess(answer, guess) # passes the answer and the guess to the checker expecting a boolean and a string back 
        
        if not correct: # gives some output if they were wrong
            print(responce, "Try Again")
    
    again = input("Congrats you won\nEnter y to play again: ") # win statment and asks the user if they would like to enter again
